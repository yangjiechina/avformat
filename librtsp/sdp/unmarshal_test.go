...
func BenchmarkUnmarshal(b *testing.B) {
	...
	//raw := []byte("v=0\r\no=- 1671634646589989 1671634646589989 IN IP4 192.168.4.248\r\ns=Media Presentation\r\ne=NONE\r\nb=AS:5100\r\nt=0 0\r\na=control:rtsp://192.168.4.248:554/\r\nm=video 0 RTP/AVP 96\r\nc=IN IP4 0.0.0.0\r\nb=AS:5000\r\na=recvonly\r\na=x-dimensions:1920,1080\r\na=control:rtsp://192.168.4.248:554/trackID=1\r\na=rtpmap:96 H265/90000\r\na=fmtp:96 sprop-vps=QAEMAf//AWAAAAMAsAAAAwAAAwB7rAk=; sprop-sps=QgEBAWAAAAMAsAAAAwAAAwB7oAPAgBDlja5JFL83BQYFAIA=; sprop-pps=RAHA8vA7NA==\r\nm=audio 0 RTP/AVP 8\r\nc=IN IP4 0.0.0.0\r\nb=AS:50\r\na=recvonly\r\na=control:rtsp://192.168.4.248:554/trackID=2\r\na=rtpmap:8 PCMA/8000\r\na=Media_header:MEDIAINFO=494D4B48010300000400050011710110401F000000FA000000000000000000000000000000000000;\r\na=appversion:1.0\r\n")
	raw := []byte("v=0\r\no=- 1131988659 1131988659 IN IP4 34.227.104.115\r\ns=BigBuckBunny_115k.mov\r\nc=IN IP4 34.227.104.115\r\nt=0 0\r\na=sdplang:en\r\na=range:npt=0- 0.0\r\na=control:*\r\n\"")
	for i := 0; i < b.N; i++ {
		var sd SessionDescription
